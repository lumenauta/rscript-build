...
R_HOME_DIR=/home/aroza/r-local/lib/R
if test "${R_HOME_DIR}" = "/home/aroza/r-local/lib/R"; then
   case "linux-gnu" in
   linux*)
     run_arch=`uname -m`
     case "$run_arch" in
     ...
     if [ -x "/home/aroza/r-local/${libnn}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/aroza/r-local/${libnn}/R"
     elif [ -x "/home/aroza/r-local/${libnn_fallback}/R/bin/exec/R" ]; then
        R_HOME_DIR="/home/aroza/r-local/${libnn_fallback}/R"
...
R_HOME="${R_HOME_DIR}"
export R_HOME
R_SHARE_DIR=/home/aroza/r-local/lib/R/share
export R_SHARE_DIR
R_INCLUDE_DIR=/home/aroza/r-local/lib/R/include
export R_INCLUDE_DIR
R_DOC_DIR=/home/aroza/r-local/lib/R/doc
export R_DOC_DIR
